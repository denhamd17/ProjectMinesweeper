...
public class Start extends EasyApp {
	...
	Button times10 = addButton("10x10", 100, 50, 100, 50, this);
	Button times15 = addButton("15x15", 100, 200, 100, 50, this);
	...
	public void actions(Object source, String command) {
		if (source == times10) {
			new Minesweeper(10, 10,0,0,1);
			dispose();
		}
		if (source == times15) {
			new Minesweeper(15, 15,0,0,1);
			dispose();
		}
		if (source == times20) {
